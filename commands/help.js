    ...
    async execute(interaction) {
        ...
        const embed = new EmbedBuilder()
            ...
            .addFields(
                ...
                { name: '/cr-my-data', value: 'View what personal data the bot has stored about you', inline: false },
                { name: '/cr-remove-data', value: 'Permanently delete all your personal data from the bot', inline: false },
